...
import { getServicePrice, getCategoryWiseServices, type Service } from "@/services/catalog-api";
        ...
        <div className="mt-4 flex items-start justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              <h3 className="text-lg font-medium text-[#6b6b6b]">{provider?.name || "Service Provider"}</h3>
  ...
  return (
    <div className="mx-auto mt-12 grid max-w-[1160px] gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {Array.from({ length: 6 }, (_, index) => (
        <div key={index} className="overflow-hidden rounded-lg border border-[#8ebce8] bg-white">
        ...
        <div className="relative mx-auto max-w-[1160px]">
          ...
          <div className="px-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[760px] text-sm text-[#667078] sm:text-base">
              Find reliable, experienced professionals for high-quality {categoryName.toLowerCase()} services near you.
            </p>
          </div>
        </div>
